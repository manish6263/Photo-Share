...
const { getAllPhotos, getPhotosById, getPhotosByCategoryId, getPhotosByPublisherId, addPhoto, updatePhoto, deletePhoto, addLike, deleteLike } = require('../controllers/photoController');

router.route('/').get(getAllPhotos);

router.route('/:id').get(getPhotosById);
