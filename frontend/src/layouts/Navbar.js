import { AddAPhoto, Camera, Login, Logout, Person } from '@mui/icons-material';
import { Alert, AppBar, Box, Button, Container, IconButton, Modal, Snackbar, Typography } from '@mui/material';
